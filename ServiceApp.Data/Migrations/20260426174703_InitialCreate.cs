        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceAreaPinCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicianProfiles", x => x.TechnicianProfileId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedTechnicianProfileId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.AssignedTechnicianProfileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bills_TechnicianProfiles_TechnicianProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceHistories", x => x.HistoryId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_TechnicianProfileId",
                table: "Bills",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceHistories_RequestId",
                table: "ServiceHistories",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_AssignedTechnicianProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TechnicianProfiles_Skill",
                table: "TechnicianProfiles",
                column: "Skill");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicianProfiles_Status",
                table: "TechnicianProfiles",
                column: "Status");
